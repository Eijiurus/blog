...
export default defineConfig({
  ...
  theme: {
    ...
    fontFamily: {
      title: ['Snell-Black', '"Source Han Serif CN"', 'ui-serif', 'Georgia', 'Cambria', '"Times New Roman"', 'Times', 'serif'],
      navbar: ['"Source Serif 4"', '"Source Han Serif CN"', 'ui-serif', 'Georgia', 'Cambria', '"Times New Roman"', 'Times', 'serif'],
      time: ['Snell-Bold', 'ui-serif', 'Georgia', 'Cambria', '"Times New Roman"', 'Times', 'serif'],
      serif: ['"Source Serif 4"', '"Source Han Serif CN"', 'ui-serif', 'Georgia', 'Cambria', '"Times New Roman"', 'Times', 'serif'],
    },
  },
  rules: [
    ['scrollbar-hidden', {
